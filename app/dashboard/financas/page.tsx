...
const lancamentos = [
  { descricao: "Receita de vendas — Março", tipo: "entrada" as const, valor: "R$ 96.200" },
  { descricao: "Pagamento fornecedores", tipo: "saida" as const, valor: "R$ 18.000" },
  { descricao: "Salários", tipo: "saida" as const, valor: "R$ 12.000" },
  { descricao: "Receita serviços", tipo: "entrada" as const, valor: "R$ 32.230" },
  { descricao: "Manutenção", tipo: "saida" as const, valor: "R$ 4.100" },
];
          ...
          {lancamentos.map((l) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                <span className={`text-sm font-medium ${l.tipo === "entrada" ? "text-green-600 dark:text-green-400" : "text-red-500"}`}>
